...
<ul class="actions fit">
    <li><a
     ...
     class="button big fit icon fa-external-link"
     href="https://orcid.org/0000-0002-4875-4894"
     target="orcid.widget"
...
<ul>
	...
	<li>Graduated in Computer Engineering (Laurea Vecchio Ordinamento, DR 1652/1938, equivalent to Masters in Computer Science and Engineering), Summa cum Laude, grade average 29.16 over 30 (GPA 4 over 4). Department of Informatics and Automation, College of Engineering, University Roma Tre, Italy. Degree awarded on March 14, 2003. Advisor Prof. Alberto Paoluzzi, Co-advisor Prof. Antonio DiCarlo (Department of Studies on Structures, University Roma Tre). Dissertation "Stokes BSP: a data structure to compute coboundary and differential forms".</li>
</ul>
...
<dl>
	<dt>Gruppo21</dt>
	<dd>
		<p>Co-founder of the official Italian National Body to the ISO JTC1/SC22 Working Group 21 (C++ Programming Language).</p>
	</dd>
	<dt>++it</dt>
	<dd>
		<p>Co-founder of the Italian C++ Community (<a href="https://italiancpp.org">https://italiancpp.org</a>).</p>
	</dd>
	<dt>Engineering Order</dt>
	<dd>
		<p>Member of the Italian Order of Engineers.</p>
	</dd>
</dl>
...
<dl>
	<dt>ISCRA HP10C1MML0 (2023)</dt>
	<dd>
		<p>Collaborator: Mechanical strength of perforated graphene membrane for water, CINECA Supercomputer Consortium ISCRA.</p>
	</dd>
	<dt>PRIN 2017L7X3CS_002 (2017--2020)</dt>
	<dd>
		<p>Collaborator: 3D printing: a bridge to the future, Ministero dell'Istruzione e del Merito.</p>
	</dd>
	<dt>RM3 (2018)</dt>
	<dd>
		<p>Collaborator: Inclusive Memory, Università degli Studi Roma Tre.</p>
	</dd>
	<dt>AFOSR 12141951 (2017)</dt>
	<dd>
		<p>Collaborator: Highly reconfigurable, multistable composites with tunable global/local morphing capability, Air Force Office of Scientific Research, USA.</p>
	</dd>
	<dt>AFOSR FA9550-14-1-0082 (2014)</dt>
	<dd>
		<p>Collaborator: Bridging High Strength and Dissipation in Carbon Nanotube Composites, Air Force Office of Scientific Research, USA.</p>
	</dd>
	<dt>Velletri 70 V003 (2015)</dt>
	<dd>
		<p>PI: Interactive gestures-based application for the Bimillennial Anniversary of Augustus, Innovation in Archaeology grant.</p>
	</dd>
	<dt>SSBAR 5233 (2014)</dt>
	<dd>
		<p>PI: Ostia Antica Mobile for Deaf (ASL/LIS), Mobile Archaeology Innovation grant.</p>
	</dd>
	<dt>ISCRA HP10CU1H2A (2014)</dt>
	<dd>
		<p>PI: Parallel High-throughput Error Correction via Oligomers, CINECA Supercomputer Consortium ISCRA. </p>
	</dd>
	<dt>SSBAR 20798 (2012)</dt>
	<dd>
		<p>PI: National Roman History Musem for Families, Mobile Archaeology Innovation grant.</p>
	</dd>
	<dt>SSBAR (2012)</dt>
	<dd>
		<p>PI: National Roman History Musem Mobile for Deaf (ASL/LIS), Mobile Archaeology Innovation grant.</p>
	</dd>
</dl>
...
<dl>
	<dt>Deformation Animation</dt>
	<dd>
		<p>Parallel transport of vector fields (deformations) on 3D manifolds via Thin Plate Spline and Finite Elements.</p>
	</dd>
	<dt>Computational Mechanics</dt>
	<dd>
		<p>Non-linear elastic and elastoplastic deformations on solids, and reconstruction of Frequency Response Curves using a Newton-Raphson path-foloowing approach. </p>
	</dd>
</dl>
...
<dl>
	<dt>Genetic Sequences Parsing</dt>
	<dd>
		<p>Parser of large Next-Generation Sequences (NGS), employing Intel's SIMD operations (AVX) with a nonlinear encoding of genetic strings.</p>
	</dd>
	<dt>Fluid Dynamics</dt>
	<dd>
		<p>Fast and optimized simulation of metal 3D printing processes (Laser Metal Deposition technology) with metal particle simulation released by nozzles and phase-change due to particles-laser interactions.</p>
	</dd>
	<dt>Genetic Optimization</dt>
	<dd>
		<p>Parallel genetic optimization algorithm for nonlinear mechanical properties of single-walled carbon nanotubes.</p>
	</dd>
	<dt>Analysis of Large DNA Sequences</dt>
	<dd>
		<p>Parallel analysis of large Next-Generation Sequences (NGS), based on the de Bruijn graph on desktops and mobile devices.</p>
	</dd>
	<dt>Ostia Antica LIS/ASL iOS & Android (2016)</dt>
	<dd>
		<p>Multiplatform mobile application---iOS and Android---tailored for deaf people, for the Roman excavation site of Ostia Antica, Rome. In collaboration with the Italian Ministry for Cultural Heritage, and the ISSR, the Italian school for deaf of Rome.</p>
	</dd>
	<dt>Sarcophagus of Hercules (2016)</dt>
	<dd>
		<p>Gesture-based application based on the Microsoft Kinect SDK for the 50th anniversary of the discovery of the "Sarcophagus of Hercules' Labors" in Velletri, Rome. In collaboration with the Italian Ministry for Cultural Heritage, and the Archaeological Museum of Velletri.</p>
	</dd>
	<dt>Bimillenary of the Emperor Augustus (2014)</dt>
	<dd>
		<p>Gesture-based application based on the Microsoft Kinect 2.0 SDK for the Bimillenary of the Emperor Augustus, in Velletri, Rome. In collaboration with the Italian Ministry for Cultural Heritage, and the Archaeological Museum of Velletri.</p>
	</dd>
	<dt>Palazzo Massimo Family iOS & Android (2014)</dt>
	<dd>
		<p>Multiplatform mobile application---iOS and Android---tailored for families, for the museum "Palazzo Massimo". In collaboration with the Italian Ministry for Cultural Heritage.</p>
	</dd>
	<dt>Palazzo Massimo LIS/ASL iOS & Android (2012)</dt>
	<dd>
		<p>Multiplatform mobile application---iOS and Android---tailored for deaf people, for the museum "Palazzo Massimo". In collaboration with the Italian Ministry for Cultural Heritage, and the ISSR, the Italian school for deaf of Rome.</p>
	</dd>
	<dt>Econometric Modeling (2007)</dt>
	<dd>
		<p>Analysis and development of predictive tools (commercial, residential, productive terrains) for the Italian territory with machine-learning techniques. Joint collaboration with Sogei company and the Italian National Territorial Agency.</p>
	</dd>
	<dt>System Administrator (2003)</dt>
	<dd>
		<p>System engineer at the Department of Studies on Structures, College of Engineering, Roma Tre University.</p>
	</dd>
	<dt>Software Developer (2002)</dt>
	<dd>
		<p>Multi-platform Qt-based IDE for the PLaSM programming language under MacOS X, Windows, and Linux, Department of Informatics and Automation, College of Engineering, Roma Tre University.</p>
	</dd>
</dl>
...
<dl>
	<dt>2022-present</dt>
	<dd>
		<p>Lecturer for "Computer Graphics". Laurea Magistrale (Masters Degree) in Computer Science and Engineering, Department of Civil, Computer Science and Aeronautical Technologies Engineering, Roma Tre University.</p>
	</dd>
	<dt>2016-present</dt>
	<dd>
...
<dl>
	<dt>2003-2005</dt>
	<dd>
		<p>Visiting graduate student at the Spatial Automation Laboratory, Department of Mechanical Engineering, University of Wisconsin-Madison, USA, 2003--2005.</p>
	</dd>
	<dt>2003</dt>
	<dd>
		<p>IBM EMEA University Relations Student Recognition Event, IBM Hursley, UK, December 2003.</p>
	</dd>
</dl>
...
<p>Watercolors and painting, Linguistics, Classical piano, Japanese language and culture, Classical guitar, Orienteering, Hiking.</p>
