...
<ul>
	...
	<li>Videogame Storytelling, by Evan Skolnicl</li>
	<li>The Game Narrative Toolbox, by Heussner et al.</li>
	<li>Foundations of Game Engine Development, by Eric Lengyel</li>
	<li>Elevating Game Experiences with Unreal Engine 5, by Marques et al.</li>
	<li>Blueprints Visual Scripting for Unreal Engine 5, by Romero et al.</li>
	<li>Multiplayer Game Development with Unreal Engine 5, by Secchi</li>
	<li>The Advanced Game Narrative Toolbox, by Heussner (ed.)</li>
	<li>Interactive Stories and Video Game Art, by Solarski</li>
